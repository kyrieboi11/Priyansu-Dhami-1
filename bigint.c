...
struct Node* additionofBigNumbers(struct Node* num1, struct Node* num2) {
...
struct Node* subtractionofBigNumbers(struct Node* num1, struct Node* num2) {
    struct Node* result = NULL;
    struct Node* temp;
    int borrow = 0;
...
// Function to multiplication of two big numbers represented as linked lists
struct Node* multiplicationofBigNumbers(struct Node* num1, struct Node* num2) {
...
struct Node* divisionofBigNumbers(struct Node* num1, struct Node* num2) {
    struct Node* result = NULL;
